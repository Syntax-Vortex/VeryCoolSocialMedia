...
export default function CreatePostModal(props) {
    ...
    const { isLoading, uploadPost, ErrorPopup: UploadError } = useCreatePost();
                ...
                <div className='flex flex-col gap-4 w-[95%] sm:w-[70%] md:w-[50%] lg:w-[35%] h-[85%] bg-black rounded-xl border-2 border-gray-300'>
                    ...
                    <div className='flex flex-col gap-2 mx-4'>
                        ...
                        <div className='w-full flex flex-wrap gap-6 items-center justify-start bg-black'>
                            <label className="inline-flex items-center cursor-pointer">
                                <input type="radio" name="theme" value="gradient-lavender" className="hidden peer" onChange={(e) => setTheme(e.target.value)} checked={theme === 'gradient-lavender'} />
                            ...
                            <label className="inline-flex items-center cursor-pointer">
                                <input type="radio" name="theme" value="gradient-indigo" className="hidden peer" onChange={(e) => setTheme(e.target.value)} checked={theme === 'gradient-indigo'} />
                            ...
                            <label className="inline-flex items-center cursor-pointer">
                                <input type="radio" name="theme" value="gradient-rose" className="hidden peer" onChange={(e) => setTheme(e.target.value)} checked={theme === 'gradient-rose'} />
                            ...
                            <label className="inline-flex items-center cursor-pointer">
                                <input type="radio" name="theme" value="gradient-coral" className="hidden peer" onChange={(e) => setTheme(e.target.value)} checked={theme === 'gradient-coral'} />
                            ...
                            <label className="inline-flex items-center cursor-pointer">
                                <input type="radio" name="theme" value="gradient-teal" className="hidden peer" onChange={(e) => setTheme(e.target.value)} checked={theme === 'gradient-teal'} />
                            ...
                            <label className="inline-flex items-center cursor-pointer">
                                <input type="radio" name="theme" value="gradient-midnight" className="hidden peer" onChange={(e) => setTheme(e.target.value)} checked={theme === 'gradient-midnight'} />
                            ...
                            <label className="inline-flex items-center cursor-pointer">
                                <input type="radio" name="theme" value="gradient-ember" className="hidden peer" onChange={(e) => setTheme(e.target.value)} checked={theme === 'gradient-ember'} />
                            ...
                            <label className="inline-flex items-center cursor-pointer">
                                <input type="radio" name="theme" value="gradient-carbon" className="hidden peer" onChange={(e) => setTheme(e.target.value)} checked={theme === 'gradient-carbon'} />
                            ...
                            <label className="inline-flex items-center cursor-pointer">
                                <input type="radio" name="theme" value="gradient-amethyst" className="hidden peer" onChange={(e) => setTheme(e.target.value)} checked={theme === 'gradient-amethyst'} />
                            ...
                            <label className="inline-flex items-center cursor-pointer">
                                <input type="radio" name="theme" value="gradient-bronze" className="hidden peer" onChange={(e) => setTheme(e.target.value)} checked={theme === 'gradient-bronze'} />
                            ...
                            <label className="inline-flex items-center cursor-pointer">
                                <input type="radio" name="theme" value="gradient-slate" className="hidden peer" onChange={(e) => setTheme(e.target.value)} checked={theme === 'gradient-slate'} />
                            ...
                            <label className="inline-flex items-center cursor-pointer">
                                <input type="radio" name="theme" value="gradient-crimsonsoft" className="hidden peer" onChange={(e) => setTheme(e.target.value)} checked={theme === 'gradient-crimsonsoft'} />
                    ...
                    <div className='flex w-full flex-1 justify-center items-center gap-4'>
                        ...
                        <button className='bg-blue-700/80 text-[20px] rounded-[10px] px-6 py-1 text-white hover:bg-blue-700/50 hover:text-white/50 duration-150'
                            onClick={handleUploadPost} disabled={isLoading}>
                            {isLoading? (<MinimalLoader />) : 'Post'}
                        </button>
                    </div>
                </div>
            </div>
