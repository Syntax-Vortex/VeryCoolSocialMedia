    ...
    return (
        <div className="h-[100vh] py-8 sticky top-0 left-0 px-2 md:px-4 w-full">
            <div className="flex flex-col items-center w-full h-full gap-10">
                ...
                <div className="w-[80%] flex flex-col gap-3 items-start justify-center mt-auto">
                    <div>
                        <img className="w-45 h-auto mt-auto ml-2 hover:scale-[1.01] duration-250" src="/name.png" />
                    </div>

                    <button className="flex gap-4 justify-center md:justify-start items-center rounded-4xl hover:bg-red-900 w-full h-10 md:pl-3 duration-150 mt-auto hover:scale-[1.01]"
