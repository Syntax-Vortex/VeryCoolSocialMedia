...
function EditProfileModal(props) {
    ...
    const { selectedFile, selectedFileString, handleImageChange, setSelectedFile, ErrorPopup } = usePreviewing();
    ...
    async function handleEditProfile() {
        try {
            const success = await editProfile(inputs, selectedFile);
            ...
            <div className='flex flex-col h-[50%] justify-start items-center bg-black z-10 text-white border-2 border-[#49434A] rounded-3xl pt-1'>
                ...
                <div className='w-full h-full flex justify-center items-center'>
                    <div className='flex flex-col justify-center items-center gap-2 mx-6 ml-8'>
                        <img className='rounded-full size-40' src={selectedFileString || `${authUser.pfp}?t=${pfpUpdatedAt}`}></img>
